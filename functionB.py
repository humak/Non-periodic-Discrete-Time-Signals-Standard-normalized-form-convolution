...
plt.scatter(arrXxStaNorm, arrXyStaNorm, label = 'X', color = '#f29595')
plt.scatter(arrYxStaNorm, arrYyStaNorm, label = 'Y', color = '#ddd264')

plt.xlabel('x')
plt.ylabel('y')
plt.title('Visualization of standard normalized form of the signals X and Y')
plt.legend()
plt.show()
